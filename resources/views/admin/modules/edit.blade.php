                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select(
                                        'status',
                                        [null => trans('admin.modules.form.parent_module_placeholder')] + $modules,
                                        $obj->parent_id,
                                        [
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    {!! Form::textarea('active_cases', $obj->active_cases, [
                                        'class' => 'form-control',
                                        'id' => 'active_cases',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::text('url_slug', $obj->url_slug, [
                                        'class' => 'form-control',
                                        'id' => 'url_slug',
                                        'placeholder' => trans('admin.modules.form.url_placeholder'),
                                    ]) !!}
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select(
                                        'status',
                                        [null => trans('admin.modules.form.status_placeholder')] + FOEM_STATUS,
                                        $obj->status,
                                        [
                                            'class' => 'form-control  select2',
                                        ],
