                        ...
                        <div class="row">
                                        ...
                                        @if ($modules && count($modules))
                                            @foreach ($modules as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $obj->parent_id == $item->id ? 'selected' : '' }}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Enter Name"
                                        name="name" value="{{ $obj->name }}" required>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="icon" placeholder="Enter Icon"
                                        name="icon" value=" {{ $obj->icon }}" required>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="active_cases" name="active_cases" rows="3" required>{{ $obj->active_cases }}</textarea>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="url" placeholder="Enter Url"
                                        name="url" value="{{ $obj->url }}" required>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="url_slug" placeholder="Enter Url Slug"
                                        name="url_slug" value="{{ $obj->url_slug}}">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control  select2" name="is_multi_level" id="is_multi_level"
                                        ...
                                        <option value="1" {{ $obj->is_multi_level == 1 ? 'selected' : '' }}>YES
                                        </option>
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-primary"
                                        onclick="submitPostForm('#CreateForm','{{ route('admin.modules.update', $obj->id) }}')">Update</button>
                                    <a href="{{ route('admin.modules.index') }}" class="btn btn-soft-success">Cancel</a>
                                </div>
                            </div>
                            <!--end col-->
                        </div>
